...
{ 
    Console.WriteLine($"Значение элемента {searchyRow} строки и {searchyColumn} столбца : {NewArray[searchyRow-1,searchyColumn-1]}"); // } // else // { // Console.WriteLine("Числа нет в массиве"); // }
